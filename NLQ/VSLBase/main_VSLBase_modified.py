"""Main script to train/test VSLBase modified (no shared encoder) for Ego4D NLQ dataset.
"""
import argparse
import os
...
from model.VSLBase_modified import build_optimizer_and_scheduler, VSLBase_modified
