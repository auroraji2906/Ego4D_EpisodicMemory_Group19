"""VSLBase for Ego4D Episodic Memory -- Natural Language Queries. 
Modified to use separate encoders for video and text modalities.
"""
import torch
...
class VSLBase_modified(nn.Module):
    def __init__(self, configs, word_vectors):
        super(VSLBase_modified, self).__init__()
        ...
        # Separate encoders for video and text modalities
