"""Main script to train/test VSLNet modified (no shared encoder) for Ego4D NLQ dataset.
"""
import argparse
import os
...
from model.VSLNet_modified import build_optimizer_and_scheduler, VSLNet_modified
